<!--  
	...
	xxx_jsp.java -> index_jap.java -> xxx_jasp.class -> xxx_jsp.obj -> response -->
	...
	<form action="/demo2/loginproc" method="post">
		...
		<div class="form-group">
			<label for="password">Password : </label> <input type="password" class = "form-control"
				placeholder="Enter password" id="password" name="password" value="asd123">
		</div>
		<div class = "form-group">
			<label for="isRemeber" > Remember me </label> <input type="checkbox" 
